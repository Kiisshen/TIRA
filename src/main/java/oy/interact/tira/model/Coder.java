 ...
 * violates this condition should clearly indicate this fact. The recommended language is "Note: this
...
public class Coder implements Comparable<Coder> {
	 ...
	 * methods will be natural order. Meaning, alphabetical order A...Ö (by
	 ...
	 * this before.
	 * 
	 * Calculate the hash for the Coder. In this case, the hash must be related
